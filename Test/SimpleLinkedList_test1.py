...
class find_all_test(unittest.TestCase):
    ...
    # 5. Связанный список из 10 узлов с одинаковыми значениями - узла с таким значением
    # нет в списке
    ...
    # 6. Связанный список из 10 узлов с разными значениями - узел с таким значением
    # есть в списке
    ...
    # 7. Связанный список из 10 узлов с разными значениями - узлы с таким значением
    # есть в списке
